...
class Fashion(models.Model):
    ...
    thumbnail1 = models.ImageField(upload_to='Fashion_thumbnails/', null=True, blank=True)
    thumbnail2 = models.ImageField(upload_to='Fashion_thumbnails/', null=True, blank=True)
    thumbnail3 = models.ImageField(upload_to='Fashion_thumbnails/', null=True, blank=True)
