...
class FashionRetrieveUpdateDestroy(generics.RetrieveUpdateDestroyAPIView):
    ...
    try:
        ...
        if serializer.is_valid():
            ...
            for follower in followers:
                Notification.objects.create(user=follower.user, message=notification_message)
...
class CreatorUpdateRetrieveUpdateDestroyView(generics.RetrieveUpdateDestroyAPIView):
...
class CreatorFollowingRetrieveUpdateDestroy(generics.RetrieveUpdateDestroyAPIView):
    ...
    def delete(self, request, pk):
        following = Following.objects.filter(creator=pk, user=request.user.id).first()
        if following:
            following.delete()
