...
from .views import (
                    ...
                    CreatorUpdateRetrieveUpdateDestroyView,
...
urlpatterns = [
    ...
    path('fashion-details/<int:pk>/', getFashionDetails, name='fashion-details'), 
     path('fashion_update/<int:pk>/', FashionRetrieveUpdateDestroy.as_view(), name='fashion_update'),
    path('creators/', views.getCreators, name='creators'),
    path('creators/creator/<int:creator_id>/', views.get_creator_details, name='get_creator_details'),
    ...
    path('creator/update/<int:pk>/', CreatorUpdateRetrieveUpdateDestroyView.as_view(), name='creator-retrieve-update-destroy'),
    ...
    path('likes/<int:pk>/', LikeRetrieveUpdateDestroy.as_view(), name='like-retrieve-update-destroy'),
    
    # Review Ratings URLs
    path('review-ratings/', ReviewRatingListCreate.as_view(), name='review-rating-list-create'),
    path('review/create/', views.create_ReviewRating, name='create'),
    path('review-ratings/<int:pk>/', ReviewRatingRetrieveUpdateDestroy.as_view(), name='review-rating-retrieve-update-destroy'),

    # Creator Review Ratings URLs
    path('creator-ratings/', CreatorReviewRatingListCreate.as_view(), name='review-rating-list-create'),
    path('creator/review/create/', create_creator_Review, name='creator_review_create'),
    path('creator-ratings/<int:pk>/', CreatorReviewRatingRetrieveUpdateDestroy.as_view(), name='review-rating-retrieve-update-destroy'),

    #following
    path('creator_following/', FollowListCreate.as_view(), name='creator_following'),
    path('create_creator_following/', create_follow, name='create_following'),
    path('creator_following_update/<int:pk>/', CreatorFollowingRetrieveUpdateDestroy.as_view(), name='creator_following_update'),

     #favorite
    path('favorites/', FavoriteListCreate.as_view(), name='favorites'),
    path('add_favorite/', add_favorite, name='add_favorite'),
    path('favorite_update/<int:pk>/', FavoriteRetrieveUpdateDestroy.as_view(), name='favorite_update'),
]
